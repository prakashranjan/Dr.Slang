...
<form class="form-wrapper cf" action="search.php" method="post">
  ...
  <li><a class="active tab" href="rate.php">Rate Us!</a></li>
  ...
  <li><a class="tab" href="contact.php">Contact us</a></li>
      ...
      <div id="heading"><h1>Rate Us!</h1></div>
	 <iframe class="rate" src="https://docs.google.com/forms/d/16rtGf-FSPCUkWDsLl8Tbe3Oa71bLcnKk92Dbl5jVIWQ/viewform?embedded=true" width="930" height="500" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
