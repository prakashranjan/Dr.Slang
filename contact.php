...
<script type='text/javascript' src='//eclkmpbn.com/adServe/banners?tid=52667_80535_0&type=slider&animate=on&size=728x90'></script>
<style type="text/css">
#logo {float:left;
position:absolute;
top:-20px;
...
<form class="form-wrapper cf" action="search.php" method="post">
  ...
  <li><a class="active tab" href="contact.php">Contact us</a></li>
</ul>  </div>


      <div id="heading"><h1>Contact Us!</h1></div>
	 </br></br><div id="contact"><ul class="soc">
...
<h2> Thank you for using our site .
    For any query you can contact </br>us on any of the above shown social networking sites. </br></br>
	Site Admin :<em>prakashranjansingh04@gmail.com</em></h2>
</div>
...
<script type="text/javascript">
  ( function() {
    ...
    var unit = {"calltype":"async[2]","publisher":"prs786","width":250,"height":250,"sid":"Chitika Default"};
