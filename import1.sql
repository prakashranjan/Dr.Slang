...
--
-- Host: localhost
-- Generation Time: Jul 23, 2015 at 09:30 AM
...
-- Database: `1000253`
--
CREATE DATABASE `1000253` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `1000253`;

-- --------------------------------------------------------

--
-- Table structure for table `tblAbbre`
--

CREATE TABLE IF NOT EXISTS `tblAbbre` (
  `abbreno` int(11) NOT NULL AUTO_INCREMENT,
  `abbre` varchar(50) DEFAULT NULL,
  `abbrefull` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`abbreno`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `tblAbbre`
--

INSERT INTO `tblAbbre` (`abbreno`, `abbre`, `abbrefull`) VALUES
...
('def', '1000253', 'tblAbbre', 'abbreno', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '1000253', 'tblAbbre', 'abbre', 2, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', '1000253', 'tblAbbre', 'abbrefull', 3, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', '');
...
('ABORTED_CONNECTS', '20408'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BINLOG_STMT_CACHE_DISK_USE', '0'),
('BINLOG_STMT_CACHE_USE', '0'),
('BYTES_RECEIVED', '4257179618'),
('BYTES_SENT', '198743529189'),
('COM_ADMIN_COMMANDS', '167670'),
...
('COM_ALTER_SERVER', '0'),
('COM_ALTER_TABLE', '3304'),
('COM_ALTER_TABLESPACE', '0'),
('COM_ANALYZE', '5'),
('COM_BEGIN', '2425'),
('COM_BINLOG', '0'),
('COM_CALL_PROCEDURE', '0'),
('COM_CHANGE_DB', '2292937'),
('COM_CHANGE_MASTER', '0'),
('COM_CHECK', '9'),
('COM_CHECKSUM', '0'),
('COM_COMMIT', '38869'),
...
('COM_RELEASE_SAVEPOINT', '5017'),
('COM_RENAME_TABLE', '1'),
('COM_RENAME_USER', '0'),
('COM_REPAIR', '0'),
('COM_REPLACE', '86261'),
('COM_REPLACE_SELECT', '1685'),
('COM_RESET', '0'),
('COM_RESIGNAL', '0'),
('COM_REVOKE', '0'),
('COM_REVOKE_ALL', '0'),
...
('COM_SAVEPOINT', '5017'),
('COM_SELECT', '4930067'),
('COM_SET_OPTION', '4462027'),
('COM_SIGNAL', '0'),
('COM_SHOW_AUTHORS', '0'),
('COM_SHOW_BINLOG_EVENTS', '0'),
('COM_SHOW_BINLOGS', '344'),
('COM_SHOW_CHARSETS', '1420'),
...
('COM_SHOW_CREATE_TABLE', '1288'),
('COM_SHOW_CREATE_TRIGGER', '0'),
('COM_SHOW_DATABASES', '637'),
('COM_SHOW_ENGINE_LOGS', '0'),
('COM_SHOW_ENGINE_MUTEX', '0'),
('COM_SHOW_ENGINE_STATUS', '0'),
('COM_SHOW_EVENTS', '0'),
('COM_SHOW_ERRORS', '0'),
('COM_SHOW_FIELDS', '51790'),
('COM_SHOW_FUNCTION_STATUS', '5'),
('COM_SHOW_GRANTS', '178'),
('COM_SHOW_KEYS', '2064'),
('COM_SHOW_MASTER_STATUS', '263'),
('COM_SHOW_OPEN_TABLES', '0'),
('COM_SHOW_PLUGINS', '212'),
('COM_SHOW_PRIVILEGES', '0'),
('COM_SHOW_PROCEDURE_STATUS', '5'),
('COM_SHOW_PROCESSLIST', '11511'),
('COM_SHOW_PROFILE', '0'),
('COM_SHOW_PROFILES', '17'),
('COM_SHOW_RELAYLOG_EVENTS', '0'),
('COM_SHOW_SLAVE_HOSTS', '0'),
('COM_SHOW_SLAVE_STATUS', '263'),
('COM_SHOW_STATUS', '24'),
('COM_SHOW_STORAGE_ENGINES', '46'),
('COM_SHOW_TABLE_STATUS', '2855'),
('COM_SHOW_TABLES', '44296'),
('COM_SHOW_TRIGGERS', '58'),
('COM_SHOW_VARIABLES', '3894'),
('COM_SHOW_WARNINGS', '111'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '55470'),
('COM_STMT_EXECUTE', '55950'),
('COM_STMT_FETCH', '0'),
('COM_STMT_PREPARE', '55964'),
('COM_STMT_REPREPARE', '0'),
('COM_STMT_RESET', '13832'),
('COM_STMT_SEND_LONG_DATA', '0'),
('COM_TRUNCATE', '598'),
('COM_UNINSTALL_PLUGIN', '0'),
('COM_UNLOCK_TABLES', '613'),
('COM_UPDATE', '1455695'),
('COM_UPDATE_MULTI', '1787'),
('COM_XA_COMMIT', '0'),
('COM_XA_END', '0'),
('COM_XA_PREPARE', '0'),
('COM_XA_RECOVER', '0'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '2924873'),
('CREATED_TMP_DISK_TABLES', '210239'),
('CREATED_TMP_FILES', '3750'),
('CREATED_TMP_TABLES', '500048'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '400'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '1422428'),
('HANDLER_DELETE', '191985'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '622700'),
('HANDLER_READ_KEY', '173233436'),
('HANDLER_READ_LAST', '35306'),
('HANDLER_READ_NEXT', '1362286574'),
('HANDLER_READ_PREV', '16258975'),
('HANDLER_READ_RND', '77406442'),
('HANDLER_READ_RND_NEXT', '2996196620'),
('HANDLER_ROLLBACK', '847'),
('HANDLER_SAVEPOINT', '5014'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '21146771'),
('HANDLER_WRITE', '194274165'),
('INNODB_BUFFER_POOL_PAGES_DATA', '32214'),
('INNODB_BUFFER_POOL_BYTES_DATA', '527794176'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '563'),
('INNODB_BUFFER_POOL_BYTES_DIRTY', '9224192'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '554956'),
('INNODB_BUFFER_POOL_PAGES_FREE', '0'),
('INNODB_BUFFER_POOL_PAGES_MISC', '553'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '32767'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '36607'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '6631'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1622109616'),
('INNODB_BUFFER_POOL_READS', '512347'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '3862638'),
('INNODB_DATA_FSYNCS', '373858'),
('INNODB_DATA_PENDING_FSYNCS', '1'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '9033355264'),
('INNODB_DATA_READS', '556935'),
('INNODB_DATA_WRITES', '902114'),
('INNODB_DATA_WRITTEN', '18711578112'),
('INNODB_DBLWR_PAGES_WRITTEN', '554956'),
('INNODB_DBLWR_WRITES', '10933'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '741083'),
('INNODB_LOG_WRITES', '322659'),
('INNODB_OS_LOG_FSYNCS', '329547'),
('INNODB_OS_LOG_PENDING_FSYNCS', '1'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '524017152'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '19724'),
('INNODB_PAGES_READ', '551218'),
('INNODB_PAGES_WRITTEN', '554956'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '54612'),
('INNODB_ROW_LOCK_TIME_AVG', '95'),
('INNODB_ROW_LOCK_TIME_MAX', '32073'),
('INNODB_ROW_LOCK_WAITS', '569'),
('INNODB_ROWS_DELETED', '21887'),
('INNODB_ROWS_INSERTED', '276379'),
('INNODB_ROWS_READ', '1471892233'),
('INNODB_ROWS_UPDATED', '701148'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '92040'),
('KEY_BLOCKS_USED', '254145'),
('KEY_READ_REQUESTS', '212182733'),
('KEY_READS', '1449673'),
('KEY_WRITE_REQUESTS', '4669864'),
('KEY_WRITES', '2939161'),
...
('OPEN_FILES', '21963'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '11810'),
('OPEN_TABLES', '12288'),
('OPENED_FILES', '1512562'),
('OPENED_TABLE_DEFINITIONS', '225190'),
('OPENED_TABLES', '235854'),
...
('QCACHE_FREE_BLOCKS', '23310'),
('QCACHE_FREE_MEMORY', '61982408'),
('QCACHE_HITS', '15257085'),
('QCACHE_INSERTS', '4189082'),
('QCACHE_LOWMEM_PRUNES', '1092072'),
('QCACHE_NOT_CACHED', '550690'),
('QCACHE_QUERIES_IN_CACHE', '63178'),
('QCACHE_TOTAL_BLOCKS', '189066'),
('QUERIES', '32388385'),
('QUESTIONS', '32263119'),
('RPL_STATUS', 'AUTH_MASTER'),
('SELECT_FULL_JOIN', '16157'),
('SELECT_FULL_RANGE_JOIN', '1638'),
('SELECT_RANGE', '367924'),
('SELECT_RANGE_CHECK', '1171'),
('SELECT_SCAN', '907121'),
...
('SSL_VERIFY_MODE', '0'),
('SSL_VERSION', ''),
('TABLE_LOCKS_IMMEDIATE', '8110582'),
('TABLE_LOCKS_WAITED', '3448'),
('TC_LOG_MAX_PAGES_USED', '0'),
('TC_LOG_PAGE_SIZE', '0'),
('TC_LOG_PAGE_WAITS', '0'),
('THREADS_CACHED', '8'),
('THREADS_CONNECTED', '2'),
('THREADS_CREATED', '53082'),
('THREADS_RUNNING', '2'),
('UPTIME', '60757'),
('UPTIME_SINCE_FLUSH_STATUS', '60757');
...
('def', '1000253', 'PRIMARY', 'def', '1000253', 'tblAbbre', 'abbreno', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 65739264, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 66819522, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 65431080, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 67028580, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 66297000, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 67032080, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 67064931, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 66248336, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 67078276, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 66952192, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 66954133, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 67022450, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 67057200, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 67098003, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 66894360, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 66994768, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 66906354, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-07-23 14:30:44', '2015-07-23 14:30:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6852, 0, 67067376, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 67075996, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 257, 0, 65329400, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 66996952, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 60817408, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 52428800, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 67080868, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 60817408, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 52428800, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6669, 0, 67076802, 0, 0, '2015-07-23 14:30:44', NULL, NULL, NULL, '', '', NULL),
('def', '1000253', 'tblAbbre', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 36, 36, 281474976710655, 2048, 0, '2015-07-23 14:24:25', '2015-07-23 14:25:41', NULL, NULL, '', '', NULL);
...
(2924645, '1000253', 'localhost', '1000253', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', '1000253', 'utf8', 'utf8_general_ci', NULL);
...
('''1000253''@''localhost''', 'def', '1000253', 'SELECT', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'INSERT', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'UPDATE', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'DELETE', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'CREATE', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'DROP', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'REFERENCES', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'INDEX', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'ALTER', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'CREATE TEMPORARY TABLES', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'LOCK TABLES', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'CREATE VIEW', 'NO'),
('''1000253''@''localhost''', 'def', '1000253', 'SHOW VIEW', 'NO');
...
('ABORTED_CLIENTS', '6489'),
('ABORTED_CONNECTS', '20418'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BINLOG_STMT_CACHE_DISK_USE', '0'),
('BINLOG_STMT_CACHE_USE', '0'),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '1820'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '1894'),
('INNODB_BUFFER_POOL_PAGES_DATA', '32213'),
('INNODB_BUFFER_POOL_BYTES_DATA', '527777792'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '507'),
('INNODB_BUFFER_POOL_BYTES_DIRTY', '8306688'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '555397'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '36607'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '6631'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1622142987'),
('INNODB_BUFFER_POOL_READS', '512349'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '3864270'),
('INNODB_DATA_FSYNCS', '374195'),
('INNODB_DATA_PENDING_FSYNCS', '1'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '9033404416'),
('INNODB_DATA_READS', '556938'),
('INNODB_DATA_WRITES', '902879'),
('INNODB_DATA_WRITTEN', '18726299136'),
('INNODB_DBLWR_PAGES_WRITTEN', '555397'),
('INNODB_DBLWR_WRITES', '10939'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '741303'),
('INNODB_LOG_WRITES', '322971'),
('INNODB_OS_LOG_FSYNCS', '329861'),
('INNODB_OS_LOG_PENDING_FSYNCS', '1'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '524286464'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '19731'),
('INNODB_PAGES_READ', '551221'),
('INNODB_PAGES_WRITTEN', '555397'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '54612'),
('INNODB_ROW_LOCK_TIME_AVG', '95'),
('INNODB_ROW_LOCK_TIME_MAX', '32073'),
('INNODB_ROW_LOCK_WAITS', '569'),
('INNODB_ROWS_DELETED', '21887'),
('INNODB_ROWS_INSERTED', '276380'),
('INNODB_ROWS_READ', '1471991372'),
('INNODB_ROWS_UPDATED', '701460'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '91467'),
('KEY_BLOCKS_USED', '254145'),
('KEY_READ_REQUESTS', '212254374'),
('KEY_READS', '1450605'),
('KEY_WRITE_REQUESTS', '4670573'),
('KEY_WRITES', '2939670'),
...
('OPEN_FILES', '21967'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '11809'),
('OPEN_TABLES', '12288'),
('OPENED_FILES', '1513493'),
...
('PERFORMANCE_SCHEMA_THREAD_INSTANCES_LOST', '0'),
('PREPARED_STMT_COUNT', '0'),
('QCACHE_FREE_BLOCKS', '23474'),
('QCACHE_FREE_MEMORY', '61950472'),
('QCACHE_HITS', '15260348'),
('QCACHE_INSERTS', '4190240'),
('QCACHE_LOWMEM_PRUNES', '1092780'),
('QCACHE_NOT_CACHED', '550795'),
('QCACHE_QUERIES_IN_CACHE', '62902'),
('QCACHE_TOTAL_BLOCKS', '188868'),
('QUERIES', '32395699'),
('QUESTIONS', '147'),
('RPL_STATUS', 'AUTH_MASTER'),
('SELECT_FULL_JOIN', '0'),
...
('SSL_VERIFY_MODE', '0'),
('SSL_VERSION', ''),
('TABLE_LOCKS_IMMEDIATE', '8113091'),
('TABLE_LOCKS_WAITED', '3452'),
('TC_LOG_MAX_PAGES_USED', '0'),
('TC_LOG_PAGE_SIZE', '0'),
('TC_LOG_PAGE_WAITS', '0'),
('THREADS_CACHED', '2'),
('THREADS_CONNECTED', '13'),
('THREADS_CREATED', '53115'),
('THREADS_RUNNING', '2'),
('UPTIME', '60772'),
('UPTIME_SINCE_FLUSH_STATUS', '60772');
...
('def', '1000253', 'tblAbbre', 0, '1000253', 'PRIMARY', 1, 'abbreno', 'A', 1, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 65739264, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=174762', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 66819522, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=290514', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 65431080, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=344148', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=11210', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 67028580, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=26163', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 66297000, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=136956', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=2475', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 67032080, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=25068', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 67064931, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=14472', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=24200', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=22317', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=45313', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=95596', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 66248336, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=217885', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 67078276, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=13940', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=2334', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 66952192, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=19373', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 66954133, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=30798', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 67022450, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=11665', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 67057200, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7101', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 67098003, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=9654', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 66894360, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=26800', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 66994768, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28292', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=2277', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 66906354, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=33790', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-07-23 14:30:57', '2015-07-23 14:30:57', NULL, 'utf8_general_ci', NULL, 'max_rows=27742', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6852, 0, 67067376, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=9794', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 67075996, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=14801', ''),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 257, 0, 65329400, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=261123', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 66996952, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=112034', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 60817408, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2314098', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 52428800, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2684354', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 67080868, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2147', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 60817408, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2314098', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 52428800, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2684354', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6669, 0, 67076802, 0, 0, NULL, '2015-07-23 14:30:57', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=10062', ''),
('def', '1000253', 'tblAbbre', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 36, 36, 281474976710655, 2048, 0, 2, '2015-07-23 14:24:25', '2015-07-23 14:25:41', NULL, 'utf8_general_ci', NULL, '', '');
...
('def', '1000253', 'PRIMARY', '1000253', 'tblAbbre', 'PRIMARY KEY');
...
('''1000253''@''localhost''', 'def', 'USAGE', 'NO');
