...
<form class="form-wrapper cf" action="search.php" method="post">
  ...
  <li><a class="active tab" href="comment.php">Comment</a></li>
  <li><a class="tab" href="contact.php">Contact us</a></li>
</ul>  </div>


      <div id="heading"><h1>Comment here!</h1></div>
	 <iframe class="rate" src="https://docs.google.com/forms/d/1zn4z7XJ5GDt_KJD_OEE6Tu5ucLO79uB-LnayPt2YARU/viewform?embedded=true" width="930" height="500">Loading...</iframe>
