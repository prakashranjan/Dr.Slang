...
<script type='text/javascript' src='//eclkmpbn.com/adServe/banners?tid=52667_80535_4&type=footer&size=468x60'></script>
<style type="text/css">
#logo {float:left;
position:absolute;
top:-20px;
...
<form class="form-wrapper cf" action="search.php" method="post">
  ...
  <li><a class="active tab" href="owner.php">Admin</a></li>
  <li><a class="tab" href="comment.php">Comment</a></li>
  <li><a class="tab" href="contact.php">Contact us</a></li>
</ul>  </div>


      <div id="heading"><h1>Administrator Den( Only for site owner )</br>Under Process.......</h1></div>
	  
	  
	  <div  id="data"><br/>
 <br /><form action="owner.php" method="post">
 <strong>PASSWORD</strong>:<input type="password" name="password" size="20"/>
...
width:900px;
'>   
<legend>ENTER DATA</legend>	<form style='font-family:Comic Sans MS;' action='owner.php' method='post' >
			
			<br />	<p>short form:<input style='border: 1px solid #FF3E96 ;
    border-radius: 10px;
    opacity:0.5;
    -webkit-appearance: none;
	padding:10px;'name='sform' type='text' size='20'/>
	
				   full form:<input style='border: 1px solid #FF3E96 ;
    border-radius: 10px;
    opacity:0.5;
    -webkit-appearance: none;
	padding:10px;'name='fform' type='text' size='40' />
	
	
				   <input style=' border: 1px solid #FF3E96 ;
    border-radius: 14px;
    padding:10px;
    -webkit-appearance: none;'type='submit' value='submit' name='Submit2'/> 
...
<br>"; 
  ...
  else {echo"</br><h2>WRONG PASSWORD </br> <a  style='color:#FF3E96;
  border:3px solid #FF3E71 ;
  border-radius:10px;
  background-color:pink;'href='owner.php'><em>try again</em></a></h2>";}	}	   ?>
...
<img  class="left" src="left5.jpg" height="380" width="280" > </img>
   <div id="ad5ve"></div>
<div id="ad5ve2"></div></div>
</body>
</html>